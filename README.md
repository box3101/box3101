...
안녕하세요. 열정을 가지고 웹 프론트엔드로 경력을 쌓아온 이찬용입니다. 저는 웹사이트 개발과 운영을 통해 다양한 기업과 프로젝트를 성공적으로 완료해왔습니다.

이러한 업무를 수행하면서, 저는 여러 웹 개발 기술을 숙달하고 프로젝트 관리 능력을 향상시켜왔습니다. 여기에는 인천광역시 통합 웹사이트 운영 및 구축, 인천광역시 중구청 평생교육포털 개발, 삼성 SDI GSOP 시스템 개발 등 다양한 프로젝트가 포함되어 있습니다.

또한, 저는 새로운 프레임워크와 기술에 대한 열정을 가지고 있습니다. ASTRO는 최근에 나온 신생 프레임워크로, 그 효율적이고 편리한 개발환경을 제가 직접 경험하였습니다. 이를 바탕으로 향후 다양한 프로젝트에도 활용해나갈 계획입니다.

저의 포트폴리오 페이지 https://box3101.github.io/cy-web에서는 저의 이러한 경력과 능력을 보다 상세히 확인하실 수 있습니다.
...
저는 팀에서 적극적인 역할을 하며, 동료들과의 협력을 중요시합니다. 또한, 항상 새로운 기술과 지식에 대해 배우는 것을 즐깁니다.
