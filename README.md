...
ASTRO를 사용하면 마크업을 쉽게 유지보수할 수 있었습니다. 또한, 설정이 새로운 Gulp 대신에 사용됨으로써 좋았습니다. 

단, CSS나 JS 파일이 한 파일에 묶여 minify 처리되지 않는 점은 아쉬웠습니다. 

하지만, ASTRO는 아직 많이 개발되고 있으며, 이후에 나올 업데이트에서 이러한 문제점도 개선될 것으로 기대합니다.

ASTRO를 사용하여 웹 프로젝트를 진행하면서, 효율적이고 편리한 개발환경을 경험하였습니다.
